...
export default function Hero() {
  const words = [
    ...
    "JavaScript Developer & PHP/Laravel Enthusiast",
    "Linux & GitHub for DevOps Enthusiast",
  ];

  const [code] = useState(`
const profile = {
    name: 'Abdulmuaz Alshaikhli',
    title: 'Full-Stack Developer | Programming Enthusiast | Problem Solver',
    skills: [
        'Javascript', 'JQuery', 'React', 'NextJS', 'VueJS', 'TypeScript',
        'PHP', 'Laravel', 'MySQL', 'PostgresSQL', 'Docker', 
        'Git', 'Linux', 'Java', 'C#', 'TailwindCSS', 'Bootstrap', 
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Fullstack Developer 🚀 | Creating Projects 🛠️ | Coding the
                  future 💻✨
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/Abdul-M777"
                  target="_blank"
